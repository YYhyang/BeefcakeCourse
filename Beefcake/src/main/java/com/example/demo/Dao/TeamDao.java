...
public class TeamDao {
    ...
    public Integer getMaxTeamSerial(Long klassId) {
        return teamMapper.getMaxTeamSerial(klassId);
    }
    ...
    public boolean createTeamInKlassTeam(Long klassId, Long teamId) {
        return teamMapper.createTeamInKlassTeam(klassId, teamId);
    }

    public boolean createTeamInTeamStudent(Long teamId, Long studentId) {
        return teamMapper.createTeamInTeamStudent(teamId, studentId);
    }
    ...
    public List<TeamStrategy> getStrategyByCourseId(Long courseId) {
        return teamMapper.getStrategyByCourseId(courseId);
    }

    public void deleteTeamFromTeamStudent(Long teamId) {
        teamMapper.deleteTeamFromTeamStudent(teamId);
    }

    public void deleteTeamFromKlassTeam(Long teamId) {
        teamMapper.deleteTeamFromKlassTeam(teamId);
    }
    ...
    public List<Long> getPartMembersId(Long teamId, Long courseId) {
        return teamMapper.getPartMembersId(teamId, courseId);
    }

    //有被批过为true，没有为false
    public boolean beenApproved(Long teamId) {
        Long id = teamValidApplicationMapper.haveApplication(teamId);
        //没记录
        if (id == null) {
            return false;
        } else {
